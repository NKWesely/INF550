...
```{r}
# data <- readNWISdata(stateCd="Arizona", countyCd="Maui", service="dv", parameterCd="00060")
# head(MauiCo_avgdailyQ)

# Download precip data
# for some reason the weekly data is messed up
# so I'm downloading daily data and summing to the week
...
## Question 2
**Create two timeseries plots (one for preciptitation, one for streamflow), where color is a function of year (e.g. the x axis is month, the y axis is precipitation, legend shows color by year).**
